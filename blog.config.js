...
const BLOG = {
  ...
  LANG: process.env.NEXT_PUBLIC_LANG || 'zh-CN', 'en-US'// e.g 'zh-CN','en-US'  see /lib/lang.js for more.
  ...
  GREETING_WORDS:
    ...
    'HELLO, DREAMER of the WORLD',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Rliza', // 您的昵称 
  BIO: process.env.NEXT_PUBLIC_BIO || ' ', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || ' ', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 作品, 博客', // 网站关键词 英文逗号隔开
